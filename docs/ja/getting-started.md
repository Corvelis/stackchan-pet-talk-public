...
モデルの詳細と注意点は [モデル/辞書/ランタイムの入手先](../../MODEL_DOWNLOADS_ja.md) を確認してください。
...
詳しい入手先は [モデル/辞書/ランタイムの入手先](../../MODEL_DOWNLOADS_ja.md) を確認してください。
...
詳しい画面説明、音声AI、LLM、キャラクター設定、マスター認識などは [詳しい操作手順](../user_manual_ja.md) にまとめています。
